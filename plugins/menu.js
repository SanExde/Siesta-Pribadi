exports.run = {
   ...
   async: async (m, {
      ...
      try {
      let captions = `Sistem otomatis (WhatsApp Bot) yang dapat membantu untuk melakukan sesuatu, mencari dan mendapatkan data/informasi hanya melalui WhatsApp.\n\n◦ *Database* : PostgreSQL\n◦ *Library* : Baileys v4.3.0\n◦ *My Web* : https://linktr.ee/SanzOfc\n◦ *Github* : https://github.com/SanTzy\n\njika Anda menemukan kesalahan atau ingin meningkatkan paket premium, hubungi owner.\n\n
乂  *USER INFO*
...
◦  ${isPrefix}runtime`
      client.sendMessageModify(m.chat, captions, m, {
      	       title: 'SanzX Bot Premium',
               largeThumb: true,
               thumbnail: await Func.fetchBuffer('https://telegra.ph/file/6eeae4fa2c60b24c58bce.png'),
